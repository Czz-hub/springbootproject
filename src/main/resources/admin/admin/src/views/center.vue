<template>
  <div :style='{"minHeight":"100vh","padding":"0px 0px 20px","overflow":"hidden","color":"#666","background":"#f4f8fb","fontSize":"14px","position":"relative"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}'   v-if="flag=='yonghu'"  label="用户账号" prop="yonghuzhanghao">
          <el-input v-model="ruleForm.yonghuzhanghao" readonly              placeholder="用户账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}'   v-if="flag=='yonghu'"  label="用户姓名" prop="yonghuxingming">
        ...
        <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}'   v-if="flag=='yonghu'"  label="身高/米" prop="shengao">
          <el-input v-model="ruleForm.shengao"               placeholder="身高/米" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}'   v-if="flag=='yonghu'"  label="体重/公斤" prop="tizhong">
          <el-input v-model="ruleForm.tizhong"               placeholder="体重/公斤" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}'   v-if="flag=='yonghu'"  label="饮食类型" prop="yinshileixing">
          <el-input v-model="ruleForm.yinshileixing"               placeholder="饮食类型" clearable></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'yonghu' ==this.flag && this.ruleForm.shengao&&(!isNumber(this.ruleForm.shengao))){
        this.$message.error(`身高/米应输入数字`);
        return
      }


      if( 'yonghu' ==this.flag && this.ruleForm.tizhong&&(!isNumber(this.ruleForm.tizhong))){
