<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f4f8fb"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="饮食类型" prop="yinshileixing">
					<el-input v-model="ruleForm.yinshileixing" placeholder="饮食类型" clearable  :readonly="ro.yinshileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else class="input" label="饮食类型" prop="yinshileixing">
					<el-input v-model="ruleForm.yinshileixing" placeholder="饮食类型" readonly></el-input>
				</el-form-item>
			</template>
