		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="饮食类型" prop="yinshileixing">
					<el-select :disabled="ro.yinshileixing" v-model="ruleForm.yinshileixing" placeholder="请选择饮食类型" multiple filterable>
						<el-option
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yinshileixing = this.ruleForm.yinshileixing.split(",");
        } else {
          this.$message.error(data.msg);
        }
      });
      ...
      //更新跨表属性
       ...
       if(this.type=='cross'){
		...
		this.$refs["ruleForm"].validate(valid => {
			if (valid) {
				this.ruleForm.yinshileixing = this.ruleForm.yinshileixing.join(",");
