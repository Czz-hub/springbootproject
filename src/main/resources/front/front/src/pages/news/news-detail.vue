<template>
	<div :style='{"padding":"0 calc((100% - 1200px)/2)","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
	<el-button :style='{"border":"0px solid #1abc9e30","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0px","background":"#1ec01a","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' type="warning" size="mini" @click="backClick" class="el-icon-back">返回</el-button>
	<div :style='{"width":"100%","overflow":"hidden","flexWrap":"wrap","background":"#fff","justifyContent":"space-between","display":"flex"}'>
		<div :style='{"margin":"10px 0 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230921/eb4b56c7d55142c4b9339e032022bfb5.png) repeat-x center bottom","display":"none","width":"calc(100% - 0px)","lineHeight":"56px","height":"66px"}'>
			<div :style='{"margin":"0 auto","color":"#333","textAlign":"center","background":"none","display":"inline-block","width":"auto","fontSize":"20px","fontWeight":"500"}'>营养知识科普</div>
		</div>
		<div :style='{"minHeight":"360px","width":"calc(100% - 0px)","padding":"0px","position":"relative","background":"none","order":"1"}'>
			...
			<div :style='{"border":"0px solid #eee","padding":"0","margin":"20px 0 0","color":"#999","width":"100%","fontSize":"14px","lineHeight":"1.8","textIndent":"2em","height":"auto"}' class="content-detail" v-html="detail.content"></div>
		</div>
		<!-- option -->
		<div :style='{"padding":"0 20px","margin":"20px 0","display":"flex","width":"calc(100% - 0px)","justifyContent":"space-between","height":"auto","order":"2"}'>
		...
		<div class="hot" :style='{"width":"100%","margin":"0px auto","background":"#fff","height":"auto","order":"13"}'>
		  <div :style='{"padding":"0","borderColor":"#E5E5E5","color":"#4a576a","borderRadius":"0px","textAlign":"center","background":"#F5F5F5","borderWidth":"1px","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid","fontWeight":"600"}'>热门文章</div>
		  <div :style='{"padding":"0 0 5px 0","margin":"20px 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <div v-for="item in hotList" :key="item.id" :style='{"cursor":"pointer","width":"23%","padding":"0","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
		      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"120px"}' :src="baseUrl + item.picture" alt="">
		      <div :style='{"padding":"4px 5px 0","borderColor":"#eee","whiteSpace":"nowrap","color":"#666","textAlign":"center","overflow":"hidden","borderWidth":"0px","width":"100%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"solid","height":"auto"}'>{{ item.title }}</div>
